...
+ [Feature] Support [intelligent pointer snapping](/handbook/en/how-to/interaction/coarse-pointer). [#17102](https://github.com/apache/echarts/issues/17102) ([Ovilia](https://github.com/Ovilia))
...
+ [Feature] States enhancement:
    ...
    + Support to blur other graphic elements when highlighting specified data through mouseover or hover linking. See examples [bar-label-rotation](/next/examples/en/editor.html?c=bar-label-rotation), [bar-polar-stack](/next/examples/en/editor.html?c=bar-polar-stack), [bar-stack](/next/examples/en/editor.html?c=bar-stack), [area-stack](/next/examples/en/editor.html?c=area-stack), [dataset-link](/next/examples/en/editor.html?c=dataset-link), [scatter-weight](/next/examples/en/editor.html?c=scatter-weight), [tree-basic](/next/examples/en/editor.html?c=tree-basic).
    + Unify the previous different state configurations in series, like `highlightPolicy`, `focusNodeAdjacency`, `hoverOffset`, by the option `focus`, `blurScope` and `scale`. See examples [sankey-energy](/next/examples/en/editor.html?c=sankey-energy), [graph](/next/examples/en/editor.html?c=graph), [sunburst-drink](/next/examples/en/editor.html?c=sunburst-drink).
...
+ [Feature] Provide a more powerful label support:
    ...
    + Provide option set `labelLayout` to enable more abilities for developers to tweak the layout of the labels after it's originally positioned by the chart itself. With the options in `labelLayout`, developers can:
        + Avoid labels overlap (see [scatter-label-align-right](/next/examples/en/editor.html?c=graph-label-overlap)),
        + Make special label alignment, and adjust label position, etc.. See the examples [pie-alignTo](/next/examples/en/editor.html?c=pie-alignTo), [pie-labelLine-adjust](/next/examples/en/editor.html?c=pie-labelLine-adjust), [pie-label-distanceToLabelLine](/next/examples/en/editor.html?c=doc-example/pie-label-distanceToLabelLine), [pie-label-bleedMargin](/next/examples/en/editor.html?c=doc-example/pie-label-bleedMargin).
        + Make label draggable.
    + Support `labelLine` for all series, which is very useful for guiding element to related labels when labels have to be far away from the elements. See examples [scatter-label-align-right](/next/examples/en/editor.html?c=scatter-label-align-right), [scatter-label-align-top](/next/examples/en/editor.html?c=scatter-label-align-top). Related issues: [#11534](https://github.com/apache/incubator-echarts/issues/11534), [#12971](https://github.com/apache/incubator-echarts/issues/12971).
...
+ [Feature] Support bar realtime sorting by `series.realtimeSort`. See examples [bar-race](/next/examples/en/editor.html?c=bar-race), and see more details in the original pull request [#12484](https://github.com/apache/incubator-echarts/pull/12484).
+ [Feature] Support data transform plug-in:
    ...
    + See examples [data-transform-filter](/next/examples/en/editor.html?c=data-transform-filter), [data-transform-sort-bar](/next/examples/en/editor.html?c=data-transform-sort-bar), [data-transform-multiple-pie](/next/examples/en/editor.html?c=data-transform-multiple-pie), [doc-example/data-transform-multiple-sort-bar](/next/examples/en/editor.html?c=doc-example/data-transform-multiple-sort-bar), [boxplot-light-velocity](/next/examples/en/editor.html?c=boxplot-light-velocity), [bar-histogram](/next/examples/en/editor.html?c=bar-histogram), [scatter-clustering](/next/examples/en/editor.html?c=scatter-clustering), [scatter-exponential-regression](/next/examples/en/editor.html?c=scatter-exponential-regression), [scatter-linear-regression](/next/examples/en/editor.html?c=scatter-linear-regression), [scatter-logarithmic-regression](/next/examples/en/editor.html?c=scatter-logarithmic-regression), [scatter-polynomial-regression](/next/examples/en/editor.html?c=scatter-polynomial-regression). See more details in [#13065](https://github.com/apache/incubator-echarts/pull/13065), #13127](https://github.com/apache/incubator-echarts/pull/13127).
...
+ [Feature] Support transition animation in custom series.
    + Transition animation can be auto performed by setting property `transition` for transform related properties, style properties and shape properties. See [custom-gauge](/next/examples/en/editor.html?c=custom-gauge).
    + Support morphing/combining/separating by setting property `morph` on elements definitions. See examples [custom-combine-separate-morph](/next/examples/en/editor.html?c=custom-combine-separate-morph), [custom-one-to-one-morph](/next/examples/en/editor.html?c=custom-one-to-one-morph), [custom-story-transition](/next/examples/en/editor.html?c=custom-story-transition), [custom-spiral-race](/next/examples/en/editor.html?c=custom-spiral-race).
    + Support customized transition animation by callback `during`. See the example [custom-spiral-race](/next/examples/en/editor.html?c=custom-spiral-race), and see more details in [#12775](https://github.com/apache/incubator-echarts/pull/12775).
...
+ [Feature] Provide a more powerful gauge:
    + See examples [gauge-barometer](/next/examples/en/editor.html?c=gauge-barometer), [gauge-clock](/next/examples/en/editor.html?c=gauge-clock), [gauge-multi-title](/next/examples/en/editor.html?c=gauge-multi-title), [gauge-progress](/next/examples/en/editor.html?c=gauge-progress), [gauge-ring](/next/examples/en/editor.html?c=gauge-ring), [gauge-grade](/next/examples/en/editor.html?c=gauge-grade), [gauge-simple](/next/examples/en/editor.html?c=gauge-simple), [gauge-temperature](/next/examples/en/editor.html?c=gauge-temperature).
