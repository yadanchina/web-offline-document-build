...
$.when(
  $.getScript('/fastly.jsdelivr.net/npm/echarts-stat@1.2.0/dist/ecStat.min.js'),
  $.getScript(
    '/fastly.jsdelivr.net/npm/echarts-simple-transform@1.0.0/dist/ecSimpleTransform.min.js'
  )
).done(function () {
  init();
