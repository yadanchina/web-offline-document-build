...
$.when(
  ...
  $.getScript(
    '/fastly.jsdelivr.net/npm/echarts-simple-transform/dist/ecSimpleTransform.min.js'
  )
).done(function (res) {
  run(res[0]);
});
  ...
  const optionCreators = {
    Option_CountryAB_Year_Income_Bar: function (datasetId, specifiedCountry) {
      return {
        ...
        yAxis: Object.assign({ name: 'Income' }, AXIS_NAME_STYLE),
        series: {
          type: 'custom',
    ...
    Option_CountryAB_Year_Population_Bar: function (
      ...
      return {
        ...
        yAxis: Object.assign({ name: 'Population' }, AXIS_NAME_STYLE),
        series: {
          type: 'custom',
          coordinateSystem: 'cartesian2d',
          datasetId: datasetId,
    ...
    Option_CountryAB_Income_Population_Scatter: function (
      ...
      return {
        xAxis: Object.assign(
          Object.assign({ name: 'Income' }, AXIS_NAME_STYLE),
          { scale: true, nameLocation: 'middle' }
        ),
        yAxis: Object.assign(
          Object.assign({ name: 'Population' }, AXIS_NAME_STYLE),
          { scale: true }
        ),
        series: {
          type: 'custom',
