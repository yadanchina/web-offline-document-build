...
function ensureECharts() {
  if (typeof echarts === 'undefined') {
    return loadScriptsAsync([
      // '/fastly.jsdelivr.net/npm/echarts/dist/echarts.js'
      process.env.NUXT_ENV_DEPLOY === 'asf'
        ? '/fastly.jsdelivr.net/npm/echarts/dist/echarts.min.js'
        : '/fastly.jsdelivr.net/npm/echarts-nightly/dist/echarts.min.js',
    ]).then(() => {})
  }
