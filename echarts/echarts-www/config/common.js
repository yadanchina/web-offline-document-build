module.exports = {
  cdnThirdParty: {
    jquery: "/fastly.jsdelivr.net/npm/jquery@3.7.1/dist/jquery.min.js",
    bootstrapCSS:
      "/fastly.jsdelivr.net/npm/bootstrap@3.3.7/dist/css/bootstrap.min.css",
    bootstrapJS:
      "/fastly.jsdelivr.net/npm/bootstrap@3.3.7/dist/js/bootstrap.min.js",
    lodash: "/fastly.jsdelivr.net/npm/lodash@3.10.1/index.min.js",
    perfectScrollbarJS:
      "/fastly.jsdelivr.net/npm/perfect-scrollbar@0.6.8/dist/js/min/perfect-scrollbar.min.js",
    perfectScrollbarCSS:
      "/fastly.jsdelivr.net/npm/perfect-scrollbar@0.6.8/dist/css/perfect-scrollbar.min.css",
    paceProgressBarJS:
      "/fastly.jsdelivr.net/npm/pace-progressbar@1.0.2/pace.min.js",
    sweetalertJS:
      "/fastly.jsdelivr.net/npm/sweetalert@2.1.2/dist/sweetalert.min.js",
    echartsMinJS_4_8_0:
      "/fastly.jsdelivr.net/npm/echarts@4.8.0/dist/echarts.min.js",
    prettifyJS:
      "/fastly.jsdelivr.net/npm/code-prettify@0.1.0/src/prettify.min.js",
    // Can not find good prettify css in jsdelivr.
    // prettifyCSS: '/fastly.jsdelivr.net/npm/code-prettify@0.1.0/styles/doxy.css',
    prettifyCSSHandlerJS:
      "/fastly.jsdelivr.net/npm/code-prettify@0.1.0/src/lang-css.js",
    jqueryLazyloadJS:
      "/fastly.jsdelivr.net/npm/jquery-lazyload@1.9.7/jquery.lazyload.min.js",

    // CDN for doc
    vueJS: "/fastly.jsdelivr.net/npm/vue@2.6.14/dist/vue.min.js",
    elementUIJS: "/fastly.jsdelivr.net/npm/element-ui@2.15.14/lib/index.js",
    elementUICSS:
      "/fastly.jsdelivr.net/npm/element-ui@2.15.14/lib/theme-chalk/index.css",
    codeMirrorJS:
      "/fastly.jsdelivr.net/npm/codemirror@5.56.0/lib/codemirror.min.js",
    codeMirrorJSModeJS:
      "/fastly.jsdelivr.net/npm/codemirror@5.56.0/mode/javascript/javascript.js",
    beautifierJS:
      "/fastly.jsdelivr.net/npm/js-beautify@1.11.0/js/lib/beautifier.min.js",
  },
