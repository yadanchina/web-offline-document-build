...
(function () {
  ...
  function initAnimation() {
    ...
    for (var i = 0; i < 6; i++) {
      setLottieAnimatiion(
        "bg-icon-" + (i + 1),
        "asset/lottie/json/bg_0" + (i + 1) + ".json"
      );
      (function (i) {
    ...
    $("#page-index").scroll(function () {
      ...
      if (
        startLine >= $(window).scrollTop() &&
        startLine < $(window).scrollTop() + $(window).height() - 200
      ) {
        if (!hasStartLineShow) {
          ...
          if (animationMap["start-line"]) {
            ...
            setLottieAnimatiion(
              "start-line",
              "asset/lottie/json/start_line.json"
            );
          }
  ...
  function loadLandingAnimationScripts() {
    return new Promise((resolve) => {
      ...
      var landingAnimationURL =
        "/fastly.jsdelivr.net/npm/echarts-www-landing-animation/";
      // Load script.
      ...
      script.src =
        landingAnimationURL + "dist/echarts-www-landing-animation.js";
  ...
  window.startMagic = function () {
    ...
    function start() {
      ...
      var svgBoundingRect = document
        .querySelector(".home-landing-animation-cover svg")
      ...
      document.getElementById("home-landing-animation-close-btn").onclick =
        function () {
      ...
      if (isInited) {
        ...
        landingAnimation.init(
          document.getElementById("home-landing-animation-viewport"),
          {
